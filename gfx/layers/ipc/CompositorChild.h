...
public:
  ...
  static PCompositorChild* Get() { return sCompositor; }

protected:
  virtual PLayersChild* AllocPLayers(const LayersBackend &aBackend, const int64_t& aId, int* aMaxTextureSize);
  virtual bool DeallocPLayers(PLayersChild *aChild);

private:
  nsRefPtr<LayerManager> mLayerManager;

  static nsRefPtr<CompositorChild> sCompositor;
