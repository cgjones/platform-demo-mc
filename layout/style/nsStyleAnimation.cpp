...
AppendFunction(nsCSSKeyword aTransformFunction)
{
  ...
  arr->Item(0).SetStringValue(
    NS_ConvertUTF8toUTF16(nsCSSKeywords::GetStringValue(ToPrimitive(aTransformFunction))),
    eCSSUnit_Ident);
...
ToPrimitive(nsCSSValue::Array* aArray) {
  ...
  nsRefPtr<nsCSSValue::Array> arr = AppendFunction(tfunc);
  ...
  switch(tfunc) {
    case eCSSKeyword_translate:
    {
      ...
      arr->SetItem(2, aArray->Count() == 3 ? aArray->Item(2) : zero);
      arr->SetItem(3, zero);
      break;
    }
    case eCSSKeyword_translatex:
    ...
    case eCSSKeyword_scale:
    {
      NS_ABORT_IF_FALSE(aArray->Count() == 2 || aArray->Count() == 3,
                        "unexpected count");
      arr->SetItem(1, aArray->Item(1));
      arr->SetItem(2, aArray->Count() == 3 ? aArray->Item(2) : aArray->Item(1));
      arr->SetItem(3, one);
      break;
    }
    case eCSSKeyword_scalex:
...
AddTransformTranslate(const nsCSSValue &aValue1, double aCoeff1,
                      ...
                      nsCSSValue &aResult)
{
  if(!(aValue1.GetUnit() == eCSSUnit_Percent ||
